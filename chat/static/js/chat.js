...
// Assicuriamoci che setupScrollPagination sia implementato correttamente
...
// Implementazione corretta di setupScrollPagination
function setupScrollPagination() {
    ...
    chatMessages.addEventListener('scroll', function() {
        ...
        if (chatMessages.scrollTop < 50 && !isLoadingMessages && hasMoreMessages) {
            console.log("Scroll detected near top, loading older messages...");
            loadOlderMessages();
        }
    });
}
