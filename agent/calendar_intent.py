...
- Assegna una categoria appropriata in base al contenuto se non esplicitata:
  * work: riunioni, progetti, scadenze professionali
  * personal: hobbies, appuntamenti personali
  * family: eventi familiari, compleanni
  * health: visite mediche, terapie, allenamenti
"""
